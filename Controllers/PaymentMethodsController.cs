...
namespace DoAn_LapTrinhWeb.Controllers
{
    public class PaymentMethodsController : Controller
    {
        ...
        public ActionResult vnpay(object sender, EventArgs e)
        {
            ...
            string vnp_Url = ConfigurationManager.AppSettings["https://sandbox.vnpayment.vn/"]; //URL thanh toan cua VNPAY 
            ...
            vnpay.AddRequestData("vnp_OrderInfo", "MyComputer - Thanh toan don hang: #" + order.OrderId);
